...
extern unsigned ZLIB_INTERNAL deflate_read_buf OF((z_streamp strm, Bytef *buf, unsigned size));

void fill_window_arm(deflate_state *s) {
    register unsigned n;
    ulg more;  /* Amount of free space at the end of the window. */
    uInt wsize = s->w_size;
